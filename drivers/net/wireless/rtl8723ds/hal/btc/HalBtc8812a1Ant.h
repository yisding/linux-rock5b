...
#else
#define	ex_halbtc8812a1ant_power_on_setting(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_pre_load_firmware(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_init_hw_config(btcoexist, wifi_only) do {} while (0)
#define	ex_halbtc8812a1ant_init_coex_dm(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_ips_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_lps_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_scan_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_connect_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_media_status_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_specific_packet_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_bt_info_notify(btcoexist, tmp_buf, length) do {} while (0)
#define	ex_halbtc8812a1ant_rf_status_notify(btcoexist, type) do {} while (0)
#define	ex_halbtc8812a1ant_halt_notify(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_pnp_notify(btcoexist, pnp_state) do {} while (0)
#define	ex_halbtc8812a1ant_coex_dm_reset(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_periodical(btcoexist) do {} while (0)
#define	ex_halbtc8812a1ant_dbg_control(btcoexist, op_code, op_len, pdata) do {} while (0)
#define	ex_halbtc8812a1ant_display_coex_info(btcoexist) do {} while (0)
